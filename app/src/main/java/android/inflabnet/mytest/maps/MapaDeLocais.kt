...
import kotlinx.android.synthetic.main.activity_mapa_de_locais.*
            ...
            if (isLocationEnabled()) {
                ...
                mFusedLocationClient.lastLocation.addOnCompleteListener(this) { task ->
                    ...
                    if (location == null) {
                        ...
                        Log.i("Local", "${location.latitude}, ${location.longitude}")
                        HitApi(this,txtLat, txtLon,10000,nomeTipo!!).execute()
                    }
                }
            } else {
