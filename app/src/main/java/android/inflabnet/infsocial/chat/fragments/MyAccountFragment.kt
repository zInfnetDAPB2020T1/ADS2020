...
import android.inflabnet.infsocial.chat.SignActivity
import android.inflabnet.infsocial.chat.glide.GlideApp
import android.inflabnet.infsocial.chat.util.FirestoreUtil
import android.inflabnet.infsocial.chat.util.StorageUtil
            ...
            btn_sign_out.setOnClickListener {
                AuthUI.getInstance()
                    ...
                    .addOnCompleteListener {
                        //startActivity(intentFor<SignActivity>().newTask().clearTask())
                    }
            }
        }
