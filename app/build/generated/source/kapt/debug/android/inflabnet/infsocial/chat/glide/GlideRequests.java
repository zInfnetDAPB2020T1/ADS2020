package android.inflabnet.infsocial.chat.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof android.inflabnet.infsocial.chat.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new android.inflabnet.infsocial.chat.glide.GlideOptions().apply(toSet));
    }
  }
}
